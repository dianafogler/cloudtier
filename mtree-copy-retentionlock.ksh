...
print "  -d : Data Domain\n  -u : DD user"
print "  -s : Source Directory on server\n  -m : Source Directory on DD (start with /data/col1/ 
If source Directory is not provided, we assume it is same as the last field of Source Directory)"
print "  -t : Target Directory server\n  -n : Target Directory on DD (start with /data/col1/ 
If target Directory is not provided, we assume it is same as the last field of Target Directory)"
