...
print "  -d : Data Domain\n  -u : DD user"
print "  -s : Source Directory on server\n  -m : Source Directory on DD (after /data/col1/ 
If the last field of Source Directory on server is the mtree, this input is not required"
print "  -t : Target Directory server\n  -n : Target Directory on DD (after /data/col1/ 
If the last field of Target Directory on server is the mtree, this input is not required"
