...
function show_usage {
print "usage: ddfile-mtree-copy.ksh -o <full or partial> -d <Data Domain> -u <User> -s <Source Directory> -m <Source Mtree> -t <Target Directory> -n <Target Directory> -r <Comparing Days>" 
